...
export const MOCK_ACTIVITY = [
  { id:1, text:"Qwen2.5 extracted 4 tasks from Q1 Engineering Sync", time:"2m ago", color:"#4f8aff" },
  { id:2, text:"L1 escalation fired for Reno Red — MailHog Setup overdue", time:"1h ago", color:"#fbbf24" },
  { id:3, text:"Bala Ashwath submitted Folder Watcher Implementation", time:"3h ago", color:"#34d399" },
  { id:4, text:"Weekly prompt refinement job ran — confidence +4%", time:"1d ago", color:"#c084fc" },
];
